...
![user_detail](https://i.gyazo.com/27c31a20c3a81ede62a327339432b15e.jpg)
 ...
 ### 10.動体視力トレーニング
 スポーツ選手には欠かせない動体視力をトレーニングすることができます。スタートボタンをクリックすると、1秒毎にひとつのボタンが黄色に変化します。黄色く変化したボタンをクリックしてください。1クリック成功毎に画面したのtotalのところに1ポイントずつ加算されていきます。30秒経つと終了です。終了後はresetボタンを必ず押してください。
